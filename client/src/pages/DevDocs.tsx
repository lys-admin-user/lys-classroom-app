      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ["POST", "/api/lessons/generate-guest", "No", "Guest AI generation (email-gated; 5/month per guest bucket)"],
            ...
            ["POST", "/api/student-signup/submit", "No", "Save student pre-signup quiz answers (anonymous, session-keyed)"],
          ],
        },
      },
      {
