...
// AUTO-SPLIT from server/storage/database.ts -- domain: payments (9 methods)
...
const paymentsMethods: ThisType<DatabaseStorage> = {
...
Object.assign(DatabaseStorage.prototype, paymentsMethods);
